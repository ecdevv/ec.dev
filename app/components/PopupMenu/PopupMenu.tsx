                ...
                >   
                  <div className = "absolute inset-0 flex justify-center items-center p-8">
                    <div className = "lg:grid grid-cols-2 justify-items-center flex flex-col landscape:mh-sm:flex-row w-full justify-center items-center gap-8 portrait:mh-md:gap-3">
                      <Link href = {menuContent.link} aria-label = "Demo" target = "_blank" className = "group cursor-pointer relative lg:w-full lg:h-full w-[75%]">
                        <img
                        ...
                        <span className = "absolute inset-0 flex items-end bg-black bg-opacity-20 opacity-0 group-hover:opacity-100 transition-all duration-200">
                      ...
                      <div className = "flex flex-col justify-center lg:items-start landscape:mh-sm:items-start items-center lg:text-start landscape:mh-sm:text-start text-center lg:max-w-full sm:max-w-[85%] max-w-[88%] landscape:h-600:max-w-full landscape:mh-xs:max-w-[66%] landscape:max-w-[50%]">
                        ...
                        ? <>
                            <div className = "flex flex-col gap-1">
                              <div className = "flex flex-col">
                                ...
                                ? <div className = "flex lg:justify-start landscape:mh-sm:justify-start justify-center lg:gap-3 gap-2">
                        ...
                        <div className = "flex gap-x-2 mt-3">
                          ...
                          {menuContent.link
                          ? <Link href = {menuContent.link} target = "_blank" aria-label = "Demo" className = "group flex justify-center items-center py-2 px-4 gap-x-2 border border-secondaryBorderColor shadow bg-buttonColor hover:bg-buttonHoverColor active:bg-buttonActiveColor transition-all ease-in-out duration-[200ms]">
