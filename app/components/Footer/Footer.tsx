...
const Footer = () => {
  return (
    <footer id = "footer" className = "bg-footerColor w-full h-auto lg:py-[3rem] sm:py-[2rem] py-[2rem] z-[10]">
          ...
          <div className = "flex lg:justify-start justify-center gap-x-4">
            <Link href = "https://www.linkedin.com/" aria-label = "LinkedIn" target = "_blank" rel = "noreferrer">
              <svg 
                ...
                viewBox = "0 0 16 16"
                fill = ""
                className = "w-6 h-auto fill-footerSecondaryColor hover:fill-[hsl(212,100%,53%)] transition-all ease-in-out duration-[200ms]"
              >
