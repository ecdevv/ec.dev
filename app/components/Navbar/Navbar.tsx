        ...
        >
          <div className = "absolute flex flex-col top-0 right-0 portrait:w-[66%] landscape:w-screen h-screen bg-gray-200 gap-[2vh]">
            ...
            <ul className = "flex flex-col items-start portrait:gap-y-[6vh] landscape:gap-y-[10vh] landscape:m-auto portrait:p-[4vh] portrait:py-[8vh] landscape:p-[6vh] landscape:py-[8vh] ">
              ...
              <li>
                <Link href = "#about" className = "flex gap-x-4 font-openSans font-bold sm:text-xl text-lg hover:text-[hsl(212,100%,53%)] transition-all ease-in-out duration-[200ms]">
                  <svg
                    viewBox = "0 0 16 16"
                    fill = "currentColor"
                    className = "sm:w-7 w-6"
              ...
              <li>
                <Link href = "#portfolio" className = "flex gap-x-4 font-openSans font-bold sm:text-xl text-lg hover:text-[hsl(212,100%,53%)] transition-all ease-in-out duration-[200ms]">
                  <svg
                    viewBox = "0 0 24 24"
                    fill = "currentColor"
                    className = "sm:w-7 w-6"
              ...
              <li>
                <Link href = "#contact" className = "flex gap-x-4 font-openSans font-bold sm:text-xl text-lg hover:text-[hsl(212,100%,53%)] transition-all ease-in-out duration-[200ms]">
                  <svg
                    viewBox = "0 0 24 24"
                    fill = "currentColor"
                    className = "sm:w-7 w-6"
