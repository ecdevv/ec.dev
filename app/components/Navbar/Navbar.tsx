  ...
  return (
    <header>
      <nav className = "fixed top-0 left-0 bg-main w-full h-[5rem] shadow-md z-[10]">
        {/* Desktop Menu */}
        <div className = "flex w-full h-full max-w-[85%] justify-between items-center p-2 mx-auto">
          ...
          <div className = "hidden xl:flex gap-x-20 justify-center items-center">
            ...
            <button onClick = {toggleTheme} className = "hidden absolute right-[2.5%] xl:flex justify-center items-center">
              <svg
                viewBox = "0 0 24 24"
                fill = "currentColor"
        ...
        <CSSTransition
          ...
          unmountOnExit
        >
          <div className = "absolute flex flex-col top-0 right-0 portrait:w-[66%] landscape:w-screen h-screen bg-navbarMobileColor gap-[2vh]">
